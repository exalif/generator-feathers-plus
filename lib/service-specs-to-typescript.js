  ...
  Object.keys(properties).forEach(name => {
    ...
    switch (property.type) {
      case 'array':
        ...
        break;
      case 'object':
        subTypes = serviceSpecsToTypescript(specsService, property, feathersExtension, ++depth, propertyPath.unshift(name), typescriptGlobalEnumsArr, typescriptEnums, typescriptEnumsImports);
