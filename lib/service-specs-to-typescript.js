...
module.exports = function serviceSpecsToTypescript (specsService, feathersSpec, feathersExtension, depth = 1, propertyPath = [], typescriptGlobalEnumsArr, typescriptEnums = [], typescriptEnumsImports = [], generateTypeScriptEnums, reuseIdenticalEnums) {
...
function extractEnumsTypes(name, propertyEnums, typescriptGlobalEnumsArr, typescriptEnums, propertyPath, reuseIdenticalEnums) {
  ...
  console.log('identical by name global', identicalEnumsInGlobalArrayByValues)
  ...
  if (identicalEnumsInGlobalArray.length === 0) {
    ...
    console.log('identical by name local', identicalNewEnumsInArrayByValues)
